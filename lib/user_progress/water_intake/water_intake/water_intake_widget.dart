...
export 'water_intake_model.dart';

class WaterIntakeWidget extends StatefulWidget {
  const WaterIntakeWidget({super.key});

  static String routeName = 'waterIntake';
  static String routePath = '/waterIntake';
...
class _WaterIntakeWidgetState extends State<WaterIntakeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WaterIntakeModel());
  }
                                        ...
                                        StreamBuilder<List<WaterTrackerRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<WaterTrackerRecord>
                                                rowWaterTrackerRecordList =
                                                snapshot.data!;
                                            final rowWaterTrackerRecord =
                                                rowWaterTrackerRecordList
                                                        .isNotEmpty
                                                    ? rowWaterTrackerRecordList
                                                        .first
                              ...
                              StreamBuilder<List<WaterTrackerRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount:
                                        listViewWaterTrackerRecordList.length,
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowIconButton(
                                                  ...
                                                  onPressed: () async {
                                                    await listViewWaterTrackerRecord
                                                        .reference
                                                        .update({
                                                      ...mapToFirestore(
                                                        {
