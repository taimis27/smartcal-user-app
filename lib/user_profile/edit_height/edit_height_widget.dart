                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      await columnUserProfileRecord!.reference
                        ...
                        height: double.tryParse(_model.textController.text),
                      ...
                      await columnUserProfileRecord.reference
                          .update(createUserProfileRecordData(
                        bmiCategory:
                            functions.bmiCategory(columnUserProfileRecord.bmi),
                      ));

                      await columnUserProfileRecord.reference
                          .update(createUserProfileRecordData(
                        bmiRemark: functions.bmiCategoryRemark(
                            columnUserProfileRecord.bmiCategory),
                      ));
