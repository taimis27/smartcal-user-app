  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserProfileRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserProfileRecord> healthMetricsUserProfileRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final healthMetricsUserProfileRecord =
            healthMetricsUserProfileRecordList.isNotEmpty
                ? healthMetricsUserProfileRecordList.first
                : null;
                            ...
                            children: [
                                    ...
                                    children: [
                                      Text(
                                        valueOrDefault<String>(
                                          healthMetricsUserProfileRecord?.weight
                                              .toString(),
                                          '-',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        valueOrDefault<String>(
                                          healthMetricsUserProfileRecord?.height
                                              .toString(),
                                          '-',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      healthMetricsUserProfileRecord
                                          ?.bodyCategory,
                                      '-',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        valueOrDefault<String>(
                                          healthMetricsUserProfileRecord?.bmi
                                              .toString(),
                                          '-',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        valueOrDefault<String>(
                                          healthMetricsUserProfileRecord?.bmr
                                              .toString(),
                                          '0',
                                        ),
                                        style: FlutterFlowTheme.of(context)
