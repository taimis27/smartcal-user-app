...
import 'user_logs_model.dart';
export 'user_logs_model.dart';

class UserLogsWidget extends StatefulWidget {
  const UserLogsWidget({super.key});

  static String routeName = 'userLogs';
  static String routePath = '/userLogs';
...
class _UserLogsWidgetState extends State<UserLogsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserLogsModel());
  }
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  StreamBuilder<List<WaterTrackerRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<WaterTrackerRecord>
                                          listViewWaterTrackerRecordList =
                                          snapshot.data!;
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewWaterTrackerRecord =
                                              listViewWaterTrackerRecordList[
                                                  listViewIndex];
                                          return InkWell(
                              ...
                              child: StreamBuilder<List<ProgressRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    scrollDirection: Axis.vertical,
                                    itemCount:
                                        listViewProgressRecordList.length,
                                    itemBuilder: (context, listViewIndex) {
