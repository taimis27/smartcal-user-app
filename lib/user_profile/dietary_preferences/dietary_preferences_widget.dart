...
class DietaryPreferencesWidget extends StatefulWidget {
  ...
  static String routeName = 'dietaryPreferences';
  static String routePath = '/dietaryPreferences';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserProfileRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserProfileRecord> dietaryPreferencesUserProfileRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dietaryPreferencesUserProfileRecord =
            dietaryPreferencesUserProfileRecordList.isNotEmpty
                ? dietaryPreferencesUserProfileRecordList.first
                : null;
                    ...
                    Column(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/images/Screenshot_2024-09-13_123109.png',
                            width: 325.0,
                            fit: BoxFit.fitWidth,
                          ),
                        ),
                      ...
                      child: StreamBuilder<List<UserDietaryPreferencesRecord>>(
                        stream: queryUserDietaryPreferencesRecord(
                          queryBuilder: (userDietaryPreferencesRecord) =>
                            ...
                            'user',
                            isEqualTo:
                                dietaryPreferencesUserProfileRecord?.user,
                          ),
                          singleRecord: true,
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<UserDietaryPreferencesRecord>
                              containerUserDietaryPreferencesRecordList =
                              snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final containerUserDietaryPreferencesRecord =
                              containerUserDietaryPreferencesRecordList
                                      .isNotEmpty
                                  ? containerUserDietaryPreferencesRecordList
                                      .first
                                        ...
                                        children: [
                                          Text(
                                            valueOrDefault<String>(
                                              containerUserDietaryPreferencesRecord
                                                  ?.allergies,
                                              '-',
                                            ),
                                            style: FlutterFlowTheme.of(context)
