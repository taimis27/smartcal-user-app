...
import 'submit_feedback_model.dart';
export 'submit_feedback_model.dart';
...
class SubmitFeedbackWidget extends StatefulWidget {
  ...
  static String routeName = 'submitFeedback';
  static String routePath = '/submitFeedback';
...
class _SubmitFeedbackWidgetState extends State<SubmitFeedbackWidget> {
  late SubmitFeedbackModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubmitFeedbackModel());
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          ...
                                          content: Text(
                                              'Thankj you for sharing us your insights. We will do our best to meet your expectations as much as possible.'),
                                          actions: [
                                            TextButton(
