...
import '/user_meal_diary/total_food_intake/total_food_intake_widget.dart';
...
import 'user_meal_diary_model.dart';
export 'user_meal_diary_model.dart';

class UserMealDiaryWidget extends StatefulWidget {
  const UserMealDiaryWidget({
    super.key,
    this.resetDoc,
    this.prefDoc,
  });
  ...
  static String routeName = 'userMealDiary';
  static String routePath = '/userMealDiary';

  @override
  State<UserMealDiaryWidget> createState() => _UserMealDiaryWidgetState();
}

class _UserMealDiaryWidgetState extends State<UserMealDiaryWidget> {
  late UserMealDiaryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserMealDiaryModel());
              ...
              Stack(
                children: [
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(
                            colors: [
                              FlutterFlowTheme.of(context).gradientBlue,
                                          ...
                                          StreamBuilder<
                                            ...
                                            stream:
                                              ...
                                              singleRecord: true,
                                                    ...
                                                    List<FoodAddedConsumedRecord>
                                                        textFoodAddedConsumedRecordList =
                                                        snapshot;
                                                    final textFoodAddedConsumedRecord =
                                                        textFoodAddedConsumedRecordList
                                                                .isNotEmpty
                                                            ? textFoodAddedConsumedRecordList
                                                                .first
                                                            : null;
                                                    if (_model.textPreviousSnapshot !=
                                                            null &&
                                                        !const ListEquality(
                                                                FoodAddedConsumedRecordDocumentEquality())
                                                            .equals(
                                                                textFoodAddedConsumedRecordList,
                                                                _model
                                                                    .textPreviousSnapshot)) {
                                                      () async {
                                                        FFAppState()
                                                                .totalCalConsumed =
                                                            textFoodAddedConsumedRecord!
                                                                .totalCalConsumed;
                                                        FFAppState()
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 378.0, 0.0, 75.0),
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<FoodAddedConsumedRecord>>(
                                    stream: queryFoodAddedConsumedRecord(
                                      queryBuilder: (foodAddedConsumedRecord) =>
                                          foodAddedConsumedRecord
                                              ...
                                              .orderBy('consumedDateTime',
                                                  descending: true),
                                    )..listen((snapshot) {
                                        List<FoodAddedConsumedRecord>
                                            listViewFoodAddedConsumedRecordList =
                                            snapshot;
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          final listViewFoodAddedConsumedRecord =
                                              listViewFoodAddedConsumedRecordList[
                                                  listViewIndex];
                                          return InkWell(
                                            splashColor: Colors.transparent,
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            listViewFoodAddedConsumedRecord
                                                                .foodName,
                                                            maxLines: 2,
