...
abstract class FlutterFlowTheme {
  ...
  late Color barrierCode;
  late Color darkPrimary;
  late Color lightPrimary;
  late Color gradientBlue;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFBB83FF);
  late Color tertiary = const Color(0x3D39D2C0);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF474D51);
  ...
  late Color barrierCode = const Color(0x35000000);
  late Color darkPrimary = const Color(0xFF08675B);
  late Color lightPrimary = const Color(0xFFA3F3EA);
  late Color gradientBlue = const Color(0xFF65B0DD);
  late Color lightGrey = const Color(0xFFB4B4B4);
}
