...
class ConsumedFoodAllRecord extends FirestoreRecord {
  ConsumedFoodAllRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('consumedFoodAll');

  static Stream<ConsumedFoodAllRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ConsumedFoodAllRecord.fromSnapshot(s));

  static Future<ConsumedFoodAllRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ConsumedFoodAllRecord.fromSnapshot(s));

  static ConsumedFoodAllRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ConsumedFoodAllRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static ConsumedFoodAllRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      ConsumedFoodAllRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ConsumedFoodAllRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is ConsumedFoodAllRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createConsumedFoodAllRecordData({
...
class ConsumedFoodAllRecordDocumentEquality
    implements Equality<ConsumedFoodAllRecord> {
  const ConsumedFoodAllRecordDocumentEquality();

  @override
  bool equals(ConsumedFoodAllRecord? e1, ConsumedFoodAllRecord? e2) {
  ...
  @override
  int hash(ConsumedFoodAllRecord? e) => const ListEquality().hash([
        e?.user,
        e?.foodName,
        e?.foodCal,
        e?.foodProtein,
  ...
  @override
  bool isValidKey(Object? o) => o is ConsumedFoodAllRecord;
}
